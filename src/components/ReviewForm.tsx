...
const ReviewForm = ({ onReviewSubmitted }: { onReviewSubmitted?: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                title: "Error",
                description: "Failed to submit review. Please ensure the backend server is running.",
                variant: "destructive",
            });
        } finally {
    ...
    return (
        <section className="py-24 dark:bg-gray-950 border-t border-slate-100 dark:border-gray-800 transition-colors duration-300">
            <div className="max-w-3xl mx-auto px-6 text-center">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-10">How has urCV.ai helped your career journey? We'd love to hear from you.</p>

                <Card className="p-8 md:p-10 border-slate-200 dark:border-gray-800 shadow-sm bg-white dark:bg-gray-900">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-8">
                            <label className="block text-sm font-semibold mb-4 text-slate-700 dark:text-slate-300">Your Overall Rating</label>
                        ...
                        <div className="mb-6">
                            <label htmlFor="review-comment" className="block text-left text-sm font-semibold mb-2 text-slate-700 dark:text-slate-300 px-1">Write your review</label>
                            <Textarea
                                id="review-comment"
